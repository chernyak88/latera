...
class LibrariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create library" do
    assert_difference('Library.count') do
      post libraries_url, params: { library: { lib_address: @library.lib_address, lib_name: @library.lib_name, lib_num: @library.lib_num } }
    end
  ...
  test "should update library" do
    patch library_url(@library), params: { library: { lib_address: @library.lib_address, lib_name: @library.lib_name, lib_num: @library.lib_num } }
